...
import { projects, sectionLabels } from '../../../content/website-content';
...
export function MobileProjectsSection({ isActive }: MobileProjectsSectionProps) {
	...
	return (
			<div className="section-wrapper" data-section="projects" data-active={isActive}>
				<div className="h-full w-full flex flex-col px-4 py-4">
					<div className="flex-1 flex flex-col justify-evenly gap-3 overflow-y-auto">
						...
						<div className="hud-stagger-1">
							<h2 className="text-lg font-bold text-yellow-400 mb-2">{sectionLabels.projects.archiveTitle}</h2>
						</div>
					{/* Project Details Navigation and Details */}
					...
					<div className="hud-stagger-3">
						<div className="flex items-center gap-2">
							...
							<span className="text-white/40 font-mono" style={{ fontSize: 'clamp(10px, 3vw, 11px)' }}>
